<?php
$json = "http://10.102.76.34/api/xdevices.json?";
...
exec('scp root@10.102.76.37:/etc/asterisk/extensions.conf extensions.conf');
...
exec('scp extensions.conf root@10.102.76.37:/etc/asterisk/extensions.conf');
